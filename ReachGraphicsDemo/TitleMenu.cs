...
namespace MonoGameGraphicsDemo
{
    /// <summary>
    ...
    class TitleMenu : MenuComponent
    {
        ...
        List<FloatingMonoGame> floatingXnas = new List<FloatingMonoGame>();
            ...
            : base(game)
        {
            ...
            Entries.Add(new MenuEntry { Text = "particles",              Clicked = delegate { Game.SetActiveMenu(5); } });
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                FloatingMonoGame xna = new FloatingMonoGame();
            ...
            {
                FloatingMonoGame xna = floatingXnas[i];
        ...
        {
            DrawTitle("graphics demo", Color.CornflowerBlue, Color.Lerp(Color.Blue, Color.CornflowerBlue, 0.85f));

            // Draw the background "xna" labels.
            SpriteBatch.Begin();

            foreach (FloatingMonoGame blob in floatingXnas)
            {
